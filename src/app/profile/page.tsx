...
const ProjectPopup = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const projectData: Project = {
      ...
      repoLink,
      liveLink,
      createdBy: "authenticatedUser", // Replace with actual user ID from context
      lookingForMembers,
    };
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-indigo-900 dark:text-white tracking-tight">
...
export default function Page() {
  ...
  const [projects, setProjects] = useState<Project[]>([
    {
      ...
      description:
        "A dynamic dashboard built with React and Tailwind CSS to manage user profiles and projects.",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-card dark:to-muted">
            ...
            <CardContent className="flex flex-col items-center space-y-8">
              ...
              >
                      ...
                      <>
                        ...
                        >
                          <Button
                            ...
                            className="bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors rounded-full p-2 shadow-md"
                          >
                            Cancel
                          </Button>
                        </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {["username", "prn", "batch", "email", "mobile", "github", "linkedin"].map(
                    (field, index) => (
                      <motion.div
                        key={field}
                        initial={{ opacity: 0, y: 20 }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {badges.map((badge, index) => (
                    ...
                    >
                      ...
                      <div>
                        <h4 className="text-md font-semibold text-indigo-900 dark:text-white">
                          {badge.name}
                        </h4>
      ...
      {showProjectPopup && (
        <ProjectPopup onClose={() => setShowProjectPopup(false)} onAddProject={addProject} />
      )}
    </div>
  );
}